        ...
        <div className='about'>
            ...
            <div style={{ marginTop:'2rem',marginBottom:'10rem' }}>
                ...
                <div class="webContent ">
                    ...
                    <div class="text-center" style={{ width:'120rem' }}>
            ...
            {/* Enquiry */}
                <div class="webHeaderTwo" >
                    <div class="containerTwo">
                        <div class="text-caption">
                            ...
                            <span class="title-text-about-big1">“Treasure Hunt Team Building Activities”</span><br />are most welcomed.
                        </div>
                        ...
                        <div class="container text-center align-content-center">
                            <img class="arrow-enquiry my-4" src={ArrowEnquiry} alt='arrow-enquiry' />
                    ...
                    <div class="">
                        <img className='imgOne'src={require('../About/Collage/1.png')} alt='img1' />
                        <img className='imgTwo'src={require('../About/Collage/2.png')}  alt='img1' />
                        <img className='imgThree'src={require('../About/Collage/3.png')}  alt='img1' />
                        <img className='imgFour'src={require('../About/Collage/4.png')}  alt='img1' />
                    </div>
                </div>
                ...
                <div class="mobileHeaderTwo" >
                    <div class="containerTwo">
                        ...
                        <div class="container text-center align-content-center">
                            <div>
                                <img class="arrow-enquiry " src={ArrowEnquiry} alt='arrow-enquiry' />
                            </div>
                            <button class="btn  btn-join ">
                                Make an Enquiry
                            </button>
